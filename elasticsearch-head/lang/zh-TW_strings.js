i18n.setKeys({
	...
	"IndexOverview.DeleteIndex": "刪除索引",
	"IndexOverview.DeleteSelected": "刪除選中",
	"IndexOverview.SelectMax": "最多選擇5個索引",
	"IndexOverview.ConfirmDelete": "您確定要刪除以下索引嗎？",
	"IndexOverview.DeleteMessage": "輸入 ''{0}''  刪除 {1}. 此操作無法恢復",
	"IndexOverview.NoIndexSelected": "請至少選擇一個要刪除的索引",
	"IndexOverview.TooManySelected": "一次最多可以選擇5個索引",
	"IndexOverview.DeleteSuccess": "選中的索引已成功刪除。請重新整理以查看更新後的列表。",
	"IndexOverview.DeleteFailed": "刪除某些索引失敗",
